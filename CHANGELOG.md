...
All notable changes follow semantic versioning after implementation begins.

## Unreleased — Engineering foundation

- Established the repository as the documentation source of truth.
- Specified product, UX, architecture, viewer, domain, Prisma, pricing, AI, administration, API, deployment, quality, security and Git governance.
- Defined the dependency-ordered implementation roadmap and release gates.
- Added the reproducible pnpm/Turborepo workspace, strict shared quality configuration and validated environment contracts.
