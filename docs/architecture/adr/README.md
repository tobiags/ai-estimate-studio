...
| ADR | Decision | Status |
|---|---|---|
| [0001](0001-modular-monolith.md) | Modular TypeScript monolith in a pnpm/Turborepo workspace | Proposed |
| [0002](0002-postgresql-prisma.md) | PostgreSQL and Prisma for every environment | Proposed |
| [0003](0003-contract-first-http-api.md) | Contract-first REST API with OpenAPI 3.1 | Proposed |
| [0004](0004-provider-neutral-ai.md) | Vercel AI SDK behind domain-owned ports | Proposed |
